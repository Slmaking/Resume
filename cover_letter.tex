...
A significant milestone in my career was leading a project at Intact, where I was tasked with developing crash detection algorithms under a tight deadline. My role involved managing a team to collect and label a significant dataset and fine-tuning a bidirectional LSTM model. This initiative not only enhanced performance by 20% and reduced computation time by 10% but also demonstrated my commitment to delivering quality results under pressure.
